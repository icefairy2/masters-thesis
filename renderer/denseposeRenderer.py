...
class denseposeRenderer(glRenderer):
    ...
    def __init__(self, width=1600, height=1200, name='GL Renderer',
        ...
        self.dp_vertexIndices = self.densepose_info[
                                    'All_vertices'] - 1  # (1,7829)       #Vertex orders used in denpose info. There are repeated vetices
    ...
    def loadDensepose_info(self, dp_data_path='extra_data/densepose_uv_data/UV_Processed.mat'):
        ...
        densepose_info = sio.loadmat(
            dp_data_path)  # All_FaceIndices (13774), All_Faces(13774), All_U(7829), All_U_norm(7829), All_V(7829), All_V_norm (7829), All_vertices (7829)
